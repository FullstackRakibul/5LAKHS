    ...
    <div class="max-w-md w-full space-y-8 p-6 sm:p-8 bg-white rounded-xl shadow-lg">
      ...
      <form @submit.prevent="handleLogin" class="space-y-6">
        <div class="space-y-4">
          ...
          <button type="submit" :disabled="loading" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow 
          ...
          <!-- Autofill Button -->
          <button type="button" @click="setDemoCredentials" class="w-full flex justify-center py-2 px-4 rounded-md shadow text-sm font-medium 
