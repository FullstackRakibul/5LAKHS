      ...
      <div class="px-4 py-6 sm:px-0">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg mb-6">
          <div class="px-4 py-5 sm:p-6">
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Generate Check</h2>
            ...
            <div class="px-4 py-5 sm:p-6">
              <div class="flex justify-between items-center mb-4">
                ...
                <button v-if="showPreview" @click="downloadPDF" :disabled="downloadingPDF"
                  class="bg-indigo-600 hover:bg-indigo-70 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors disabled:opacity-50">
