<template>
  <div class="min-h-screen" style="background-color: #0f0f1a;">
    <main class="max-w-7xl mx-auto py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
      <!-- Header Section -->
      <div class="mb-12 space-y-4 animate-slide-up">
        <div>
          <h1 class="text-4xl md:text-5xl font-bold text-gradient mb-2">Dashboard</h1>
          <p class="text-secondary text-lg">Welcome back! Generate professional bank checks with ease.</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <button 
          ...
          class="glass-card group hover:border-indigo-400 hover:shadow-glow-indigo-lg transition-all duration-300 cursor-pointer transform hover:scale-105 active:scale-95"
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div class="text-left">
              <p class="text-xs font-medium text-secondary uppercase tracking-wide">New Check</p>
              <p class="text-xl font-bold text-accent-light">Generate</p>
            </div>
          </div>
        </button>
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div class="text-left">
              <p class="text-xs font-medium text-secondary uppercase tracking-wide">Checks Generated</p>
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div class="text-left">
              <p class="text-xs font-medium text-secondary uppercase tracking-wide">Fixed Amount</p>
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div class="text-left">
              <p class="text-xs font-medium text-secondary uppercase tracking-wide">Success Rate</p>
      ...
      <div class="glass-card" style="animation: slideUp 0.4s ease-out 0.4s backwards;">
        <div class="space-y-6">
          <div>
            <h2 class="text-2xl font-bold text-primary mb-2">Recent Activity</h2>
            <p class="text-secondary text-sm">Your recently generated checks</p>
          </div>
          ...
          <div v-if="recentActivity.length > 0" class="space-y-3">
            <div 
              ...
              :key="index"
              class="group p-4 rounded-xl border transition-all duration-300 hover:shadow-glow-indigo cursor-pointer"
              style="background-color: rgba(99, 102, 241, 0.05); border-color: rgba(99, 102, 241, 0.2);"
            >
              <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <!-- Activity Info -->
                <div class="flex items-start gap-3 flex-1 min-w-0 w-full sm:w-auto">
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <div class="flex items-center gap-2 mt-2 flex-wrap">
                      ...
                      <span class="text-xs font-semibold text-accent-light">
                ...
                <div class="flex items-center gap-2 w-full sm:w-auto">
                  <button 
                    @click="redownloadCheck(activity)" 
                    :disabled="generatingPDF"
                    class="flex-1 sm:flex-none button-primary py-2 px-4 text-sm flex items-center justify-center gap-2 disabled:opacity-50"
                  >
                    <svg v-if="!generatingPDF || selectedActivityIndex !== index" class="w-4 h-4" fill="none"
                      stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                      </path>
                    </svg>
                    <svg v-else class="animate-spin-indigo w-4 h-4" fill="none" stroke="currentColor"
                      viewBox="0 0 24 24">
                    ...
                    <span class="hidden sm:inline">{{ generatingPDF && selectedActivityIndex === index ? 'Generating...' : 'Download' }}</span>
                  </button>

                  <button 
                    @click="removeActivity(index)"
                    class="button-secondary py-2 px-3 text-sm"
                  >
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div v-else class="text-center py-16">
            ...
            <p class="text-primary mb-2 font-medium">No recent activity yet</p>
            <p class="text-sm text-secondary mb-6">Generate your first check to get started!</p>
            <button 
              @click="navigateToGenerator"
              class="button-primary inline-flex items-center gap-2 py-3 px-6"
            >
